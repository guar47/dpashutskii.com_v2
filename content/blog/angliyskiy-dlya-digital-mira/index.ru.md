...
Вы можете найти множество такого рода собраний на [Meetup](https://www.meetup.com/), Facebook или просто в поисковике, просто ищите Language exchange <ваш город>. Главное чтобы там общались только на английском, если при посещении вы поймете что половина времени общение идет на русском, советую поискать другой эвент.
