      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="md:w-2/3">
          <div className="md:flex md:items-center mb-6">
            <input
              className="bg-gray-200 focus:border-color-blue-700 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-800"
